...
<div class="container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-md-6 mb-3 mb-md-0">
                    ...
                    <div class="btn-group" role="group">
                        <input type="radio" class="btn-check" name="viewOption" id="viewMonthly" value="monthly" {{ $view == 'monthly' ? 'checked' : '' }}>
    ...
    {{-- Monthly Calendar View (Option D) --}}
    <div id="monthly-view" class="view-content" style="display: {{ $view == 'monthly' ? 'block' : 'none' }};">
        @include('schedule.partials.monthly_view')
    </div>
</div>
