...
@section('title', 'Ubah Laboratorium')
    ...
    <div class="col-md-8">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3">
                <h5 class="mb-0">
                    <i class="bi bi-pencil"></i> Ubah Data Laboratorium
                </h5>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{ route('labs.update', $lab) }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('location') is-invalid @enderror" 
                                       id="location" name="location" value="{{ old('location', $lab->location) }}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-grid gap-2 mt-4">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save"></i> Perbarui Laboratorium
                        </button>
