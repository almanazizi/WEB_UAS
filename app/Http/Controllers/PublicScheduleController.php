...
class PublicScheduleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $view = $request->get('view', 'monthly'); // monthly (default), calendar, lab, or table
        
        // For monthly view, get entire month of bookings
        if ($view === 'monthly') {
            ...
            $bookings = $this->getBookingsQuery($date, null, $labId)->get();
        }
